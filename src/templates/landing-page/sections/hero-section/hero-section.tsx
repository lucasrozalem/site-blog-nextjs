...
export const HeroSection = () => {
  return (
    <section className="container relative flex items-center justify-center md:mt-0 mt-16">
      <div className="grid grid-cols-1 md:grid-cols-2 gap:8 min-h-[20rem] md:h-[36rem] items-center">
        <div className="flex flex-col items-center justify-center gap-4 md:items-start lg:items-start">
          <h1 className="text-gray-100 text-heading-hg font-sans">
            Venda seus produtos como afilidao em um único lugar
          </h1>
          ...
          <div className="flex flex-col items-center justify-center gap-4 md:items-start lg:items-start">
            ...
            <div className="text-white flex flex-col gap-2 mt-5 items-center md:intems-start lg:items-start">
